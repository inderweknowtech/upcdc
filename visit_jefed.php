...
if (isset($_GET['exdid'])) {
    ...
    $other_office_data = [];
    $sql2 = 'SELECT * FROM apex_prakhand_details WHERE survey_id="' . $row_invoice['sno'] . '"';
    ...
    function prefillZones(){
        ...
        zoneData.forEach(function(zone,index){
            ...
            if(zone.zone_image){
                ...
                if(preview){
                    preview.src = "user_data/zones/" + zone.zone_image;
                    preview.style.display = "block";
                }
    ...
    function prefillOtherOffices(){
        ...
        otherOfficeData.forEach(function(office,index){
            ...
            if(office.prakhand_image){
                ...
                if(preview){
                    preview.src = "user_data/zones/" + office.prakhand_image;
                    preview.style.display = "block";
                }
