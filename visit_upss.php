                                                        ...
                                                        foreach ($zone_data as $z) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="hidden" name="existing_zone_image[]" value="<?php echo $z['zone_image']; ?>">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="file" name="prakhand_image[]"
                                                                        class="form-control">
                                                                    <input type="hidden" name="existing_prakhand_image[]" value="<?php echo $p['prakhand_image']; ?>">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="file" name="gas_service_image[]"
                                                                        class="form-control">
                                                                    <input type="hidden" name="existing_gas_service_image[]" value="<?php echo $p['gas_service_image']; ?>">
                                                        ...
                                                        foreach ($unit_data as $p) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="hidden" name="existing_unit_image[]" value="<?php echo $p['unit_image']; ?>">
