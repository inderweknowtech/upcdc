...
if ($_GET['exdid']) {
    $exdid = $_GET['exdid'];
    $sql = "SELECT photo_id FROM apex_si_1_1 WHERE apex_id = '$exdid' LIMIT 1";
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="scripts/ajax_pcu.php" method="post" enctype="multipart/form-data"
                                  id="user_form"
                                  name="user_form">
                                <?php echo $msg; ?>
                                <div id="steps-container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    if (!empty($row_invoice['photo_id']) && file_exists($img)) { ?>
                                                        <div class="mt-2" id="society-photo-preview">
                                                            <img src="<?php echo $img; ?>"
                                                                 style="width:120px;border:1px solid #ccc;">
                                                        </div>
                                                    <?php } ?>
                                                    <?php $existingSocietyPhoto = $row_invoice['photo_id']; ?>
                                                    <input type="hidden"
                                                ...
                                                <table class="table table-bordered" id="officeContainer"
                                                    ...
                                                    <tr class="office-block-header bg-light">
                                                        ...
                                                        <th width="100%" style="color: black; font-weight: bold;">शाखाओं
                                                            का फोटो GPS टैग के साथ संलग्न करे
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px;">
                                                            <input type="file" name="zone_image[]"
                                                                   class="form-control zone-image-input"
                                                                   onchange="previewImage(this)">
                                                            <img src="" class="zone-preview"
                                                                 style="max-height:60px;margin-top:5px;display:none;">
                                                            <input type="hidden" name="zone_image_old[]"
                                                                   class="zone-image-old">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-bordered" id="prakhandContainer"
                                                    ...
                                                    <tr class="bg-light">
                                                        ...
                                                        <th width="100%" style="color: black; font-weight: bold;">
                                                            ट्रेनिंग सेंटर का फोटो GPS टैग के साथ संलग्न करे
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    <tr class="prakhand-row-template">
                                                        ...
                                                        <td>
                                                            ...
                                                            <img src="" class="zone-preview"
                                                                 style="max-height:60px;margin-top:5px;display:none;">
                                                            <input type="hidden" name="prakhand_image_old[]"
                                                                   class="prakhand-image-old">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-bordered" id="otherOfficeContainer"
                                                    ...
                                                    <tr class="bg-light">
                                                        ...
                                                        <th width="100%" style="color: black; font-weight: bold;">अन्य
                                                            कार्यालयों का फोटो GPS टैग के साथ संलग्न करे
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    <tr class="other-office-row-template">
                                                        ...
                                                        <td>
                                                            <input type="file" name="other_office_image[]"
                                                                   class="form-control" onchange="previewImage(this)">
                                                            <img src="" class="zone-preview"
                                                                 style="max-height:60px;margin-top:5px;display:none;">
                                                            <input type="hidden" name="other_office_image_old[]"
                                                                   class="other-image-old">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                        ...
                                                        <tr class="business_matrix_row"
                                                            ...
                                                            <td>
                                                                <select name="sec_2_1_2_profit_loss_<?php echo $i; ?>"
                                                                        ...
                                                                        class="form-control">
                                                                    <option value="">--select--</option>
                                                                    <option value="लाभ" <?php echo ($row_2_1_2['sec_2_1_2_profit_loss_' . $i] == 'लाभ') ? 'selected' : ''; ?>>
                                                                        लाभ
                                                                    </option>
                                                                    <option value="हानि" <?php echo ($row_2_1_2['sec_2_1_2_profit_loss_' . $i] == 'हानि') ? 'selected' : ''; ?>>
                                                                        हानि
                                                                    </option>
                                                                </select>
                                                            </td>
                                                            <td class="text-center">
                                                                <?php if ($i == $row_2_1_2['count']) { ?>
                                                                    <button type="button" class="btn btn-info btn-sm"
                                                                            onclick="add_more_business();">नई पंक्ति
                                                                        जोड़े[+]
                                                                    </button>
                                    ...
                                    <div class="step">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="hidden" id="sec_6_2_id" value="<?php echo $count_6_2; ?>">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped" id="sec_6_2_table">
                                                    ...
                                                    for ($i = 1; $i <= $count_6_2; $i++) {
                                                        ...
                                                        <tr id="sec_6_2_row_<?php echo $i; ?>">
                                                            <td>
                                                                <select name="sec_6_2_category_<?php echo $i; ?>"
                                                                        class="form-control"
                                                                        onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--select--</option>
                                                                    <option value="पदेन" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'yes') ? 'selected' : ''; ?>>
                                                                        पदेन
                                                                    </option>
                                                                    <option value="निर्वाचित" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'yes') ? 'selected' : ''; ?>>
                                                                        निर्वाचित
                                                                    </option>
                                                                    <option value="नामित" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'no') ? 'selected' : ''; ?>>
                                                                        नामित
                                                                    </option>
                                                                </select>
                                                                <div style="display:none;">
                                                                    ...
                                                                    <input type="text"
                                                                           name="sec_6_2_post_name_<?php echo $i; ?>"
                                                                           id="sec_6_2_post_name_<?php echo $i; ?>"
                                                                           class="form-control"
                                                                           value="<?php echo isset($row_6_2['sec_6_2_post_name_' . $i]) ? $row_6_2['sec_6_2_post_name_' . $i] : ''; ?>">
                                                                    <label>निर्वाचन का वर्ष</label>
                                                                    <select name="sec_6_2_election_year_<?php echo $i; ?>"
                                                                            id="sec_6_2_election_year_<?php echo $i; ?>"
                                                                            class="form-control">
                                                                        <option value="">--Select--</option>
                                                                        <?php
                                                                        for ($y = 2022; $y >= 1975; $y--) {
                                                            ...
                                                            <td>
                                                                <select name="sec_6_2_designation_<?php echo $i; ?>"
                                                                        class="form-control"
                                                                        onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--select--</option>
                                                                    <option value="अध्यक्ष" <?php echo (isset($row_6_2['sec_6_2_designation_' . $i]) && $row_6_2['sec_6_2_designation_' . $i] == 'अध्यक्ष') ? 'selected' : ''; ?>>
                                                                        अध्यक्ष
                                                                    </option>
                                                                    <option value="उपाध्यक्ष" <?php echo (isset($row_6_2['sec_6_2_designation_' . $i]) && $row_6_2['sec_6_2_designation_' . $i] == 'उपाध्यक्ष') ? 'selected' : ''; ?>>
                                                                        उपाध्यक्ष
                                                                    </option>
                                                                    <option value="संचालक" <?php echo (isset($row_6_2['sec_6_2_designation_' . $i]) && $row_6_2['sec_6_2_designation_' . $i] == 'संचालक') ? 'selected' : ''; ?>>
                                                                        संचालक
                                                                    </option>
                                                                </select>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                       name="sec_6_2_father_name_<?php echo $i; ?>"
                                                ...
                                                <button type="button" class="btn btn-info mt-2 text-end"
                        ...
                        <div id="success">
                            <div class="mt-5 text-center">
                                ...
                                <button class="btn btn-info"
                                        onclick="window.open('preview_pcu.php?exdid=<?php echo $_GET['exdid']; ?>', '_blank');">
                                    प्रपत्र
