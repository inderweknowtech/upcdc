...
// totals
$total = mysqli_fetch_assoc(execute_query("SELECT COUNT(*) t FROM cooperatives"))['t'];
$totalFiltered = mysqli_fetch_assoc(execute_query("SELECT COUNT(*) t FROM cooperatives $where"))['t'];
