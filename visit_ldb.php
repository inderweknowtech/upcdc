...
?>
                ...
                <div class="card-body">
                    <div class="row d-flex my-auto">
                        <div class="col-md-12">
                            ...
                            <form action="scripts/ajax_ldb.php" method="post" enctype="multipart/form-data"
                                  id="user_form"
                                  name="user_form">
                                <div id="steps-container">
                                        ...
                                        <div class="table-responsive" id="zoneTableWrapper" style="display:none;">
                                            ...
                                            <table class="table table-bordered" id="officeContainer"
                                                ...
                                                <tr class="office-block-header bg-light">
                                                    ...
                                                    <th width="15%" style="color: black; font-weight: bold;">दूरभाष न०
                                                    </th>
                                                    ...
                                                    <th width="100%" style="color: black; font-weight: bold;">क्षेत्रीय
                                                        कार्यालय की फोटो GPS टैग के साथ संलग्न करे
                                                    </th>
                                                </tr>
                                                </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px;">
                                                        ...
                                                        <input type="hidden" name="existing_zone_image[]"
                                                               class="existing-zone">
                                                        <img class="zone-preview"
                                            ...
                                            <table class="table table-bordered" id="prakhandContainer"
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <th width="100%" style="color: black; font-weight: bold;">जनपदीय
                                                        शाखा की फोटो GPS टैग के साथ संलग्न करे
                                                    </th>
                                                </tr>
                                                </thead>
                                                ...
                                                <tr class="prakhand-row-template">
                                                    ...
                                                    <td><input type="text" name="prakhand_address[]"
                                                               class="form-control" placeholder="जनपदीय शाखा का पता">
                                                    </td>
                                                    <td><input type="file" name="prakhand_image[]" class="form-control">
                                                        <input type="hidden" name="existing_prakhand_image[]"
                                                               class="existing-prakhand">
                                                        <img class="prakhand-preview"
                                                             style="width:70px;margin-top:5px;display:none;">
                                                    </td>
                                                </tr>
                                                </tbody>
                                        ...
                                        <div class="table-responsive" id="branchOfficeTableWrapper"
                                            ...
                                            <table class="table table-bordered" id="branchOfficeContainer"
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <th width="20%" style="color: black; font-weight: bold;"> का पता
                                                    </th>
                                                ...
                                                <tr class="branch-office-row-template">
                                                    ...
                                                    <td><input type="text" name="branch_office_mobile[]"
                                                               class="form-control"
                                                               placeholder="शाखा कार्यालय का दूरभाष">
                                                    </td>
                                                    <td><input type="text" name="branch_office_email[]"
                                                               class="form-control"
                                                               placeholder="शाखा कार्यालय का ई-मेल">
                                                    </td>
                                                    ...
                                                    <td><input type="file" name="branch_office_image[]"
                                                               class="form-control">
                                                        <input type="hidden" name="existing_branch_image[]"
                                                               class="existing-branch">
                                                        <img class="branch-preview"
                                                             style="width:70px;margin-top:5px;display:none;">
                                                    </td>
                                                </tr>
                                                </tbody>
                                            ...
                                            <table class="table table-bordered" id="trainingCenterContainer"
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <th width="20%" style="color: black; font-weight: bold;">प्रशिक्षण
                                                        केंद्र का ई-मेल आई.डी.
                                                    </th>
                                                    <th width="20%" style="color: black; font-weight: bold;">प्रशिक्षण
                                                        केंद्र का पता
                                                    </th>
                                                    <th width="100%" style="color: black; font-weight: bold;">प्रशिक्षण
                                                        केंद्र की फोटो GPS टैग के साथ संलग्न करे
                                                    </th>
                                                </tr>
                                                </thead>
                                                ...
                                                <tr class="training-center-row-template">
                                                    <td><input type="text" name="training_center_name[]"
                                                               class="form-control"
                                                               placeholder="प्रशिक्षण केंद्र का नाम">
                                                    </td>
                                                    ...
                                                    <td><input type="text" name="training_center_address[]"
                                                               class="form-control"
                                                               placeholder="प्रशिक्षण केंद्र का पता">
                                                    </td>
                                                    <td><input type="file" name="training_center_image[]"
                                                               class="form-control">
                                                        <input type="hidden" name="existing_training_image[]"
                                                               class="existing-training">
                                                        <img class="training-preview"
                                                             style="width:70px;margin-top:5px;display:none;">
                                                    </td>
                                                </tr>
                                                </tbody>
                                    ...
                                    <div class="step">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="text-align:center;">ऋण वितरण (दिनांक 1 अप्रैल
                                                        से 31 मार्च)
                                                    </th>
                                                    ...
                                                    <th rowspan="2" style="text-align:center;">सावधि जमा योजनान्तर्गत
                                                        निक्षेपित (दिनांक 1 अप्रैल से 31 मार्च)
                                                    </th>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label>विधानसभा के पटल पर ऑडिट रिपोर्ट प्रस्तुत किये जाने का
                                                    वर्ष:</label>
                                                <select name="sec_3_agm_year" class="form-control"
                                                        tabindex="<?php echo $tab++; ?>">
                                                    <option value="">
                                    ...
                                    <div class="step">
                                        ...
                                        <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                                 style="height:50px; width:50px;"> 3.1. मुख्यालय पर कार्यरत अधिकारियों
                                            का
                                            विवरण
                                        </h4>
                                                    ...
                                                    for ($i = 1; $i <= $officer_count; $i++): ?>
                                                        <tr id="officer_row_<?php echo $i; ?>">
                                                            ...
                                                            <td><input type="date"
                                                                       ...
                                                                       class="form-control"></td>
                                                            <td><input type="text"
                                                                       name="officer_section_<?php echo $i; ?>"
                                                    ...
                                                    <div class="row sec-3-row" id="sec_3_row_<?php echo $i; ?>">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_principal_house_<?php echo $i; ?>"
                                                                        ...
                                                                        <option value="">--select--</option>
                                                                        <option value="yes" <?php echo ($row_3_3['sec_3_principal_house_' . $i] == 'yes') ? 'selected' : ''; ?>>
                                                                            हाँ
                                                                        </option>
                                                                        <option value="no" <?php echo ($row_3_3['sec_3_principal_house_' . $i] == 'no') ? 'selected' : ''; ?>>
                                                                            नहीं
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_principal_office_<?php echo $i; ?>"
                                                                        ...
                                                                        <option value="">--select--</option>
                                                                        <option value="yes" <?php echo ($row_3_3['sec_3_principal_office_' . $i] == 'yes') ? 'selected' : ''; ?>>
                                                                            हाँ
                                                                        </option>
                                                                        <option value="no" <?php echo ($row_3_3['sec_3_principal_office_' . $i] == 'no') ? 'selected' : ''; ?>>
                                                                            नहीं
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    <label>गैर-विभागीय प्रशिक्षार्थियों की
                                                                        संख्या</label>
                                                                    <input
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    <label>गैर-विभागीय प्रशिक्षार्थी प्रशिक्षण
                                                                        शुल्क</label>
                                                                    <input
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_build_year_<?php echo $i; ?>"
                                                                            ...
                                                                            tabindex="<?php echo $tab++; ?>">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1999" <?php echo ($row_3_3['sec_3_build_year_' . $i] == '1999') ? 'selected' : ''; ?>>
                                                                            2000 से पूर्व
                                                                        </option>
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_operation_year_<?php echo $i; ?>"
                                                                            ...
                                                                            tabindex="<?php echo $tab++; ?>">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1999" <?php echo ($row_3_3['sec_3_operation_year_' . $i] == '1999') ? 'selected' : ''; ?>>
                                                                            2000 से पूर्व
                                                                        </option>
                                                                        <?php for ($y = 2000; $y <= 2024; $y++) { ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_training_center_<?php echo $i; ?>"
                                                                            ...
                                                                            tabindex="<?php echo $tab++; ?>">
                                                                        <option value="">--Select--</option>
                                                                        <option value="meerut" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'meerut') ? 'selected' : ''; ?>>
                                                                            मेरठ
                                                                        </option>
                                                                        <option value="varanasi" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'varanasi') ? 'selected' : ''; ?>>
                                                                            वाराणसी
                                                                        </option>
                                                                        <option value="mahoba" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'mahoba') ? 'selected' : ''; ?>>
                                                                            महोबा
                                                                        </option>
                                                                        <option value="hewra" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'hewra') ? 'selected' : ''; ?>>
                                                                            हेवरा (ईटवा)
                                                                        </option>
                                                                        <option value="ayodhya" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'ayodhya') ? 'selected' : ''; ?>>
                                                                            अयोध्या (फैजाबाद)
                                                                        </option>
                                                                        <option value="bilari" <?php echo ($row_3_3['sec_3_training_center_' . $i] == 'bilari') ? 'selected' : ''; ?>>
                                                                            बिलारी (मोरादाबाद)
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <select name="sec_3_staff_type_<?php echo $i; ?>"
                                                                            ...
                                                                            tabindex="<?php echo $tab++; ?>">
                                                                        <option value="">--select--</option>
                                                                        <option value="union" <?php echo ($row_3_3['sec_3_staff_type_' . $i] == 'union') ? 'selected' : ''; ?>>
                                                                            उ० प्र० कोआपरेटिव यूनियन
                                                                        </option>
                                                                        <option value="authority" <?php echo ($row_3_3['sec_3_staff_type_' . $i] == 'authority') ? 'selected' : ''; ?>>
                                                                            सहकारी संघ प्राधिकारी
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <select name="sec_6_access_road" id="sec_6_access_road"
                                                                    class="form-control">
                                                                <option value="">--Select--</option>
                                                                <option value="proper" <?php echo ($row_3_1['plot_access_road'] == 'proper') ? 'selected' : ''; ?>>
                                                                    पक्की सडक
                                                                </option>
                                                                <option value="ordinary" <?php echo ($row_3_1['plot_access_road'] == 'ordinary') ? 'selected' : ''; ?>>
                                                                    कच्ची सडक
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div id="sec_3_c">
                                                        <?php for ($i = 1; $i <= $row_3_5['sec_3_c_id']; $i++) { ?>
                                                            <div class="row mb-2 sec3c_row">
                                                                ...
                                                                <div class="col-sm-2 form-group">
                                                                    <label>स्थान (समिति प्रांगण <br> या अन्य
                                                                        स्थान)</label>
        ...
        <div id="success">
            ...
            <div class="col-sm-12 form-group my-auto" id="send_otp_button2" style="display: none">
                <button type="button" name="verify_otp_btn" id="verify_otp_btn"
                        ...
                        onClick="verify_otp_ldb($('#survey_id').val());">आगे प्रेषित करे
                </button>
            </div>
    ...
    <script>
        ...
        function addHumanResourceRow() {
            ...
            if (staffTypeSelect) {
                staffTypeSelect.onchange = function () {
                    filterPostsByType(this);
                };
            }
...
`;
    ...
    <script>
        function form_validate() {
            ...
            if (getVal("lat") === '' || getVal("long") === '') {
                msg.push('लोकेशन की जानकारी उपलब्ध नहीं है');
            }
            if (getVal("society_registration_no") === '') {
                msg.push('समिति पंजीकरण संख्या दर्ज करें');
            }

            var srcValue = '';
            if (document.getElementById('society-photo-preview')) {
                srcValue = document.getElementById('society-photo-preview').getAttribute("src");
            }

            if (getVal("society_photo") === '' && srcValue === '') {
                msg.push('समिति कि फोटो संलग्न करें');
            }
            if (getVal("sec_1_profit_loss") === '') {
                msg.push('गत वित्तीय वर्ष में लाभ/हानि कि स्थिति दर्ज करें');
            }
            if (getVal("sec_1_profit_loss_amount") === '') {
                msg.push('लाभ/हानि (धनराशि रुपये में) दर्ज करें');
            }
            if (getVal("sec_3_ownership") === '') {
                msg.push('समिति भवन का स्वामित्व कि स्थिति दर्ज करें');
            }
            if (getVal("sec_5_built_building") === '') {
                msg.push('निर्मित भवन की स्थिति स्थिति दर्ज करें');
            }
            if (getVal("sec_7_electrical_connection") === '') {
                msg.push('विद्युत कनेक्शन कि स्थिति दर्ज करें');
            }
            if (getVal("sec_8_internet_connection") === '') {
                msg.push('इण्टरनेट कनेक्शन कि स्थिति दर्ज करें');
            }
            if (getVal("sec_6_narrow_tubes") === '') {
                msg.push('सरकारी नलके का पानी कि स्थिति दर्ज करें');
            }
            if (getVal("sec_6_water_tank") === '') {
                msg.push('पानी कि टंकी कि स्थिति दर्ज करें');
            }
            if (getVal("sec_6_samarsabel") === '') {
                msg.push('सबमर्सिबल कि स्थिति दर्ज करें');
            }
            if (getVal("sec_6_handpump") === '') {
                msg.push('हैंड पंप कि स्थिति दर्ज करें');
            }
            if (getVal("error_status") == 1) {
                msg.push('सभी डाटा सही से भरे / प्रपत्र को एक भर फिर से जाच ले');
            }

            if (msg.length > 0) {
                msg.forEach(value => {
                    // Simple alert (you can replace with custom UI)
                    alert(value);
                });
            } else {
                if (document.getElementById('send_otp_button2')) {
                    document.getElementById('send_otp_button2').style.display = 'flex';
                }
                if (document.getElementById('send_otp_button3')) {
                    document.getElementById('send_otp_button3').style.display = 'flex';
                }
            }
        }
    </script>
