...
$district_name = trim($_POST['district_name'] ?? null);
...
(name, u_name, u_pass, type_id, division_id, division_name, district_id, district_name, is_active, created_at)
VALUES 
('$name','$username','$password','$type_id','$division','$division_name','$district_id','$district_name',1, NOW())";
